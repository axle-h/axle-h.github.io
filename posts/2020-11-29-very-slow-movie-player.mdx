...
![Guts of the Very Slow Movie Player](/very-slow-movie-player/guts.jpg)
...
* [10x15 cm RIBBA frame from IKEA][ikea]
  These are &lt;£2. Probably not worth the 40-minute lockdown queue, but you definitely need the depth of this specific frame.
...
![Example Frame in RGB](/very-slow-movie-player/rgb.png)

If we convert this to grayscale then it's still perfectly recognisable.

![Example Frame in Grayscale](/very-slow-movie-player/gray.png)

Taking the naive approach to 1bpp quantisation, we get this monstrosity.

![Example Frame in 1-bit Without Dithering](/very-slow-movie-player/gray-1.png)
...
![Example Frame in 1-bit Via Floyd Steinberg Dithering](/very-slow-movie-player/dithered.png)
...
* **displaySeconds** Minimum number of seconds to display each frame for.
* **schedule**
