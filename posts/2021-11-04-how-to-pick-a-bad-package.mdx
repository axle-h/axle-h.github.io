...
6. <Badge colorScheme='yellow'>NEW</Badge> Are there any known vulnerabilities? If not, then have there been any previously and do the attitudes of the maintainers towards vulnerabilities align with your own?
7. <Badge colorScheme='yellow'>NEW</Badge> Is there any actual commercial interest in keeping it maintained? (a handful of personal blogging sites don't count!)
8. <Badge colorScheme='yellow'>NEW</Badge> Is it under the exclusive control of a single individual? If yes then:
...
9. <Badge colorScheme='yellow'>NEW</Badge> Is it actually any good?! A quick scan through the source code is sometimes all you'll need to determine quality e.g.
   * Are there any tests?
