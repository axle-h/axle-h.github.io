...
> **2026-08-14 this post now reads like it was written on a cave wall.**
> A lot has changed in the last 16 months in the world of AI coding tools, making almost all of this obsolete.
> This also ran on Next.js 15.3.0 which is vulnerable to a CVE 10.0 and was actually exploited on my home network to
> such an extent that I deemed it interesting enough to write about it: <PostLink name="honeypotting-cryptojackers" />.
> I have taken this app down, please consider the rest of this article historical reference.
