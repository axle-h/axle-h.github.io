...
import type { HeadingProps, ImageProps } from '@chakra-ui/react'
import { Children } from 'react'
import type { ReactElement, ReactNode } from 'react'
import { CheckCircleIcon, LinkIcon, XIcon } from '@/components/icons'
import { findPostByName } from '@/posts'
import './mdx.css'
import { PintoraDiagram, PintoraDiagramSvg } from '@/components/diagram'
import { Latex, LatexHtml } from '@/components/latex'
...
function PostLink({ name, children }: { name: string; children?: ReactNode }) {
  const post = findPostByName(name)
  if (!post) {
